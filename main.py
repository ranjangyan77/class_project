...
# All graphs use custom CSS, not Streamlit's default
theme_plotly = None
...
# Load Excel file | comment this line if you fetch data from MySQL
...
# Function for basic descriptive analytics
def Home():
    ...
    investment_mode = float(pd.Series(df_selection['Investment']).mode()[0])  # mode() returns a Series
    ...
    # Variable distribution Histogram with explicit figure for st.pyplot()
